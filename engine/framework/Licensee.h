...
#define GAME_NAME						"Doom Reborn"		// appears on window titles and errors //Brent

#define ENGINE_VERSION					"Doom Reborn Pre-Beta v1.2"	// printed in console
...
#define CONFIG_FILE						"RebornConfig.cfg"

// base folder where the source code lives
#define SOURCE_CODE_BASE_FOLDER			"engine" //for DR, it's just the root folder
...
// win32 info
#define WIN32_CONSOLE_CLASS				"Doom Reborn WinConsole" // Brent
#define	WIN32_WINDOW_CLASS_NAME			"Doom Reborn" // Brent
#define	WIN32_FAKE_WINDOW_CLASS_NAME	"DOOMREBORN_WGL_FAKE"
